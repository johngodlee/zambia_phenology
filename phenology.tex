...
{\Large{Title: Tree species diversity mediates land-surface phenology in Zambian deciduous woodlands}}
...
The dominance of tree species from the family Fabaceae, subfamily Detarioideae, had a positive effect on season length and cumulative EVI in miombo woodlands. Previous studies have noted the importance of Detarioideae species in miombo in driving productivity, and dominating the canopy, forming large trees \citep{}. This study supports those previous observations. Detarioid dominance was not included in the best model for green-up lag, but did have a positive effect on senescence lag, suggesting that Detarioid species drive the post-rainy-season phenological signal. Given their tendency to create deep root networks \citep{}, and their conservative leaf economic spectrum traits \citep{}, it is suggested that Detarioideae species are able to extend their photosynthetic activity beyond the end of the rainy season.
